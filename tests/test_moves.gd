...
class TestLowerAccuracyByOneChance extends GutTest:
	var battle = null
	
	func after_each():
		battle = null
		
	var lower_accuracy_by_one_moves = [Constants.MOVES.MUD_SLAP, Constants.MOVES.OCTAZOOKA]
	
	func test_lowers_accuracy_one(params = use_parameters(lower_accuracy_by_one_moves)):
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR)
		var move = Constants.get_move_by_id(params)
...
class TestPerishSong extends GutTest:
	var battle = null
	
	func after_each():
		battle = null
	
	func test_all_pokemon_faint():
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD, 100)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR, 1)
		var move = Constants.get_move_by_id(Constants.MOVES.PERISH_SONG)
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "perish_song")
		assert_has(battle.opponent_team[0].battler_flags, "perish_song")
		assert_eq(battle.player_team[0].battler_flags["perish_song"][1], 3) # 4 turns (One turn already passed)
		assert_eq(battle.opponent_team[0].battler_flags["perish_song"][1], 3) # 4 turns (One turn already passed)
		battle._play_turn()
		battle._play_turn()
		battle._play_turn()
...
class TestGraduallyStronger extends GutTest:
	var battle = null
	
	func after_each():
		battle = null
	
	func test_doubles_power_each_turn():
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD, 10)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR, 50)
		var move = Constants.get_move_by_id(Constants.MOVES.ROLLOUT)
		...
		var hp: int = venusaur.current_hp

		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "gradually_stronger")
		assert_eq(battle.player_team[0].battler_flags["gradually_stronger"][2], 1)
		hp -= 2
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "gradually_stronger")
		assert_eq(battle.player_team[0].battler_flags["gradually_stronger"][2], 2)
		hp -= 3
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "gradually_stronger")
		assert_eq(battle.player_team[0].battler_flags["gradually_stronger"][2], 3)
		hp -= 5
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "gradually_stronger")
		assert_eq(battle.player_team[0].battler_flags["gradually_stronger"][2], 4)
		hp -= 8
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
		
		battle.queue_move(move, battle.player_team[0], battle.opponent_team[0])
		battle._play_turn()
		assert_does_not_have(battle.player_team[0].battler_flags, "gradually_stronger")
		hp -= 15
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)


	func test_doubles_power_with_defense_curl():
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD, 10)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR, 50)
		var move = Constants.get_move_by_id(Constants.MOVES.ROLLOUT)
		...
		battle.player_team[0].battler_flags["defense_curl"] = true
...
class TestFalseSwipe extends GutTest:
	var battle = null
	
	func after_each():
		battle = null
	
	func test_leaves_foe_with_1_hp():
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD, 100)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR, 1)
		var move = Constants.get_move_by_id(Constants.MOVES.FALSE_SWIPE)
...
class TestFuryCutter extends GutTest:
	var battle = null
	...
	func test_doubles_power_each_turn():
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD, 10)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR, 50)
		var move = Constants.get_move_by_id(Constants.MOVES.FURY_CUTTER)
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "fury_cutter")
		assert_eq(battle.player_team[0].battler_flags["fury_cutter"], 1)
		hp -= 3
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "fury_cutter")
		assert_eq(battle.player_team[0].battler_flags["fury_cutter"], 2)
		hp -= 4
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
		...
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "fury_cutter")
		assert_eq(battle.player_team[0].battler_flags["fury_cutter"], 3)
		hp -= 6
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
		
		# Caps at 160 base power
		battle.queue_move(move, battle.player_team[0], battle.opponent_team[0])
		battle._play_turn()
		assert_has(battle.player_team[0].battler_flags, "fury_cutter")
		assert_eq(battle.player_team[0].battler_flags["fury_cutter"], 4)
		hp -= 6
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)
	...
	func test_resets_when_misses():
		...
		battle.queue_move(move, battle.player_team[0], battle.opponent_team[0])
		battle._play_turn()
		assert_does_not_have(battle.player_team[0].battler_flags, "fury_cutter")
		assert_eq(battle.opponent_team[0].pokemon.current_hp, hp)


	func test_resets_when_different_move_is_used():
		var charizard: Pokemon = Pokemon.new(Constants.SPECIES.CHARIZARD, 10)
		var venusaur: Pokemon = Pokemon.new(Constants.SPECIES.VENUSAUR, 50)
		var move = Constants.get_move_by_id(Constants.MOVES.FURY_CUTTER)
