...
var current_hp: int ## This Pokemon current HP
var experience: int ## This Pokemon current experience
...
func _calculate_stats():
	...
	current_hp += stats.hp - previous_hp
